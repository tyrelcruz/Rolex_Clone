...
describe('getProxyForUrl', function() {
  ...
  describe('no_proxy=[::1],[::2]:80,10.0.0.*,*.*.*.* (IP addresses)',
    function() {
  var env = {};
  env.HTTP_PROXY = 'http://proxy';

  // Masked or generic representation of private IPs
  env.NO_PROXY = '[::1],[::2]:80,10.0.0.*,10.0.0.*:80';
  ...
  // Use CIDR or wildcarded notation
  testProxyUrl(env, '', 'http://10.0.0.*/');
  testProxyUrl(env, '', 'http://10.0.0.*:80/');
  testProxyUrl(env, '', 'http://10.0.0.*:1337/');
});
